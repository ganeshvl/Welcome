...
import com.entradahealth.entrada.android.app.personal.activities.settings.EntradaSettings.getAllAccountsTask;
...
public class PlayServicesHelper {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = packageInfo.versionCode;//EntradaApplication.getInstance().getAppVersion();
