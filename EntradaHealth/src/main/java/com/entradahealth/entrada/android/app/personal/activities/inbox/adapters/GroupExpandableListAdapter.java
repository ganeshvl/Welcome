...
import com.entradahealth.entrada.android.app.personal.activities.inbox.utils.PrintSparseArrays;
...
public class GroupExpandableListAdapter extends BaseExpandableListAdapter {
	...
	private static final String LOG_TAG = GroupExpandableListAdapter.class.getSimpleName();
	...
	public GroupExpandableListAdapter(Context context, List<Group> groups) {
		this.groups = groups;
		inflater = LayoutInflater.from(context);
		checkedPositions = new SparseArray<SparseBooleanArray>();
	}

	public GroupExpandableListAdapter(Context context, List<Group> groups, int choiceMode) {
		this(context, groups);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.group_parent_view, null);
        }
