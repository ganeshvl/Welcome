...
public class MyHostVerifier extends org.apache.http.conn.ssl.AbstractVerifier {
    ...
    String[] allowHost = {"apientrada.quickblox.com", "api.quickblox.com", "dictateapi.entradahealth.net", "moosejaw.entradahealth.net", "dictateapi-qa.entradahealth.net", "dictateapi-sales.entradahealth.net"}; 
